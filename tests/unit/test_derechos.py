...
async def test_get_punto_derechos_returns_data():
    mock_row = {
        ...
        "CAUDAL_JULIO": 9.5,
        "CAUDAL_AGOSTO": 11.0,
        "CAUDAL_SEPTIEMBRE": 13.5,
        "CAUDAL_OCTUBRE": 16.0,
        "CAUDAL_NOVIEMBRE": 18.0,
        "CAUDAL_DICIEMBRE": 19.0,
...
async def test_get_cuenca_derechos_aggregates():
    mock_row = {
        ...
        "caudal_enero_sum": 50.0,
        "caudal_febrero_sum": 50.0,
        "caudal_marzo_sum": 50.0,
        "caudal_abril_sum": 40.0,
        "caudal_mayo_sum": 30.0,
        "caudal_junio_sum": 20.0,
        "caudal_julio_sum": 20.0,
        "caudal_agosto_sum": 25.0,
        "caudal_septiembre_sum": 35.0,
        "caudal_octubre_sum": 40.0,
        "caudal_noviembre_sum": 45.0,
        "caudal_diciembre_sum": 50.0,
    }
...
async def test_get_cuenca_derechos_empty_returns_zeros():
    with patch(
        "api.routers.derechos.execute_query", return_value=[{"puntos_con_derechos": 0}]
    ):
        from api.routers.derechos import get_cuenca_derechos
...
async def test_tipo_derecho_unknown_label():
    mock_row = {
        ...
        "CAUDAL_JULIO": 0.0,
        "CAUDAL_AGOSTO": 0.0,
        "CAUDAL_SEPTIEMBRE": 0.0,
        "CAUDAL_OCTUBRE": 0.0,
        "CAUDAL_NOVIEMBRE": 0.0,
        "CAUDAL_DICIEMBRE": 0.0,
        "VOLUMEN_ANUAL": 0,
    }
    with patch("api.routers.derechos.execute_query", return_value=[mock_row]):
        from api.routers.derechos import get_punto_derechos
...
async def test_get_subcuenca_derechos_aggregates():
    mock_row = {
        ...
        "caudal_enero_sum": 25.0,
        "caudal_febrero_sum": 25.0,
        "caudal_marzo_sum": 25.0,
        "caudal_abril_sum": 20.0,
        "caudal_mayo_sum": 15.0,
        "caudal_junio_sum": 10.0,
        "caudal_julio_sum": 10.0,
        "caudal_agosto_sum": 12.0,
        "caudal_septiembre_sum": 17.0,
        "caudal_octubre_sum": 20.0,
        "caudal_noviembre_sum": 22.0,
        "caudal_diciembre_sum": 25.0,
    }
